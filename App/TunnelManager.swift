...
enum TunnelStatus: Equatable {
    ...
    var detail: String {
        switch self {
        case .disconnected:
            return "Tap Connect to start the secure tunnel."
        case .connecting:
            return "iOS is starting the VPN tunnel."
        case .connected:
            return "Your device is using the RedFluent secure tunnel."
        case .disconnecting:
            return "Stopping the VPN tunnel."
        case .failed:
            return "Open diagnostics and contact support if the issue continues."
        }
    }
}
